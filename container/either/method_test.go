...
func TestEither_Left(t *testing.T) {
	v := Left[int, int](1)
	stltest.AssertEq(t, tuple.Pack2(v.TryLeft()), tuple.Pack2(1, true))
	v.SetLeft(2)
	stltest.AssertEq(t, tuple.Pack2(v.TryLeft()), tuple.Pack2(2, true))
}

func TestEither_Right(t *testing.T) {
	v := Right[int, int](1)
	stltest.AssertEq(t, tuple.Pack2(v.TryRight()), tuple.Pack2(1, true))
	v.SetRight(2)
	stltest.AssertEq(t, tuple.Pack2(v.TryRight()), tuple.Pack2(2, true))
}
