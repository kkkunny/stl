...
func (self *_AnyLinkedHashMap[K, V]) Clone() LinkedHashMap[K, V] {
...
func (self *_AnyLinkedHashMap[K, V]) Equal(dst LinkedHashMap[K, V]) bool {
...
// ContainKey 是否包含键
func (self *_AnyLinkedHashMap[K, V]) ContainKey(k K) bool {
